...
gui.add(roof.position, "y", 0, 4, 0.01).name("Height");
gui.add(roof.rotation, "y", 0, Math.PI * 2, 0.001).name("RotationY");
...
const door = new THREE.Mesh(
  new THREE.PlaneGeometry(1.5, 2.2, 100, 100),
  new THREE.MeshStandardMaterial({
...
//We want 50 graves.
//get a random angle, then use Math.sin() and Math.cos(), both with that value to create a circle,
...
// Directional light
const moonLight = new THREE.DirectionalLight("#b9dfff", 0.12);
...
renderer.shadowMap.geometry = PCFSoftShadowMap
